...
LINEAL_CANT_NEURONAS = '256, BN, D, 128'   # Topología LIVIANA: 2 capas (antes eran 4)
LINEAL_TIPO_FUNCION  = 'relu'
LINEAL_PORC_DROPOUT  = 0.4    # levemente reducido: menos capas = menos regularización necesaria
LINEAL_L2            = 0.0
